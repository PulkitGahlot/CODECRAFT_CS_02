    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Padding(padding: EdgeInsetsGeometry.fromLTRB(15, 0, 15, 40),child: Row(children: [Expanded(child: Container(alignment: Alignment.center,height: 170,  padding: EdgeInsets.all(10),
              ...
              child: Text("""Your Go to Cryptograpy tool Armed with Text as well as Image Encrypter and Decrypter!!""",textAlign: TextAlign.center, style: GoogleFonts.dancingScript(fontSize: 25,),),),),])),
            SizedBox(
              width: 275,
              height: 90,
